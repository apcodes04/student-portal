/**
 * The Acadbyte Brand Bible - Vertical Admission Form Component
 * 
...
export function AdmissionForm({ onApplicationCreated }) {
  ...
  // Validate input values instantly on client
  ...
  // Input Change Handler with Anti-XSS Sanitization
    ...
    <div className="acad-card">
      ...
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="btn-acad-brand w-full mt-2"
        >
